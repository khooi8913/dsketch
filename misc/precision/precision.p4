...
control SwitchIngressDeparser(
    ...
    apply { 
        ...
        if(ig_intr_dprsr_md.digest_type == HH_DIGEST) {
...
control SwitchIngress(
        ...
        action generate_digest() {
            // ig_intr_dprsr_md.digest_type = HH_DIGEST;
            ig_intr_tm_md.ucast_egress_port = 320;
        }
...
// == Calculate array indices for array access
        ...
        action get_hashed_locations_1_(){
            ig_md.stage_1_loc=(bit<14>) hash1.get({
                ig_md.hash_seed_1,
        ...
        action get_hashed_locations_2_(){
            ig_md.stage_2_loc=(bit<14>) hash2.get({
                ig_md.hash_seed_2,
                ig_md.flow_id_part_1,
                // 2w0,
                ig_md.flow_id_part_2,
...
// == Register arrays for the stateful data structure
        ...
        Register<bit<32>,_>(32w16384) reg_flowid_1_1_R;
        Register<bit<32>,_>(32w16384) reg_flowid_1_2_R;
        Register<bit<32>,_>(32w16384) reg_flowid_1_3_R;
        Register<bit<32>,_>(32w16384) reg_flowid_1_4_R;
        Register<bit<32>,_>(32w16384) reg_counter_1_R;
        Register<bit<32>,_>(32w16384) reg_flowid_2_1_R;
        Register<bit<32>,_>(32w16384) reg_flowid_2_2_R;
        Register<bit<32>,_>(32w16384) reg_flowid_2_3_R;
        Register<bit<32>,_>(32w16384) reg_flowid_2_4_R;
        Register<bit<32>,_>(32w16384) reg_counter_2_R;
...
// == Randomization, for running Probabilistic Recirculation
        ...
        table threshold0 {
            key = {
                ...
                ig_md.resubmit_data_read.min_stage : ternary;
                ig_md.matched_at_stage_1 : ternary;
                ig_md.counter_read_1[19:0] : range;
            }
            actions = {
                generate_digest;
                NoAction;
        ...
        table threshold1 {
            key = {
                ...
                ig_md.resubmit_data_read.min_stage : ternary;
                ig_md.matched_at_stage_1 : ternary;
                ig_md.counter_read_2[19:0] : range;
            }
            actions = {
                generate_digest;
                NoAction;
